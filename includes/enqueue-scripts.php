...
if ( ! function_exists( 'components_theme_enqueue' ) ) :
	function components_theme_enqueue(){
		...
		wp_enqueue_style( 'styles', get_stylesheet_directory_uri() . '/assets/vendor/bootstrap/dist/css/bootstrap.css' );
		...
		// Bootstrap	
		wp_enqueue_script( 'bootstrap', get_stylesheet_directory_uri() . '/assets/vendor/bootstrap/dist/js/bootstrap.min.js', array('jquery'), '3.3.6', true );
