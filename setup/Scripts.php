...
class Scripts
{
    ...
    public static function enqueue(){
        ...
        wp_enqueue_style( 'styles', get_stylesheet_directory_uri() . '/public/styles.css?v='.filemtime(get_stylesheet_directory() . '/public/styles.css') );
        ...
        // Scripts
        wp_enqueue_script( 'scripts', get_stylesheet_directory_uri() . '/public/scripts.js?v='.filemtime(get_stylesheet_directory() . '/public/scripts.js'), array(), '0.0.1', true );
